...
def glimpse3dirolist(magnitudes_file, sourcelist, version):
    ...
    print '{} is the output'.format(outfile_data)

    if os.path.exists(outfile_data):
        print 'This file {} already exists. Removing and Recreating.'.format(outfile_data)
        #os.remove(outfile)
